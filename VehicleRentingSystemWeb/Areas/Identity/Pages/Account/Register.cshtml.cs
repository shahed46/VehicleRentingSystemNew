...
using VehicleRentingSystem.Utility;

namespace VehicleRentingSystemWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (claim == null)
            {
                ...
                Input = new InputModel()
                {
                    ...
                    RoleList = _roleManager.Roles.Where(x => x.Name != "Admin" && x.Name != "Employee").Select(x => x.Name).Select(i => new SelectListItem
                    {
                        Text = i,
                        Value = i
                    }),
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile? file, string? returnUrl = null )
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.VehicleNo=Input.VehicleNo;
